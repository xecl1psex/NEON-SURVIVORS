...
function recalcMagnetRange(){let base=80,mult=1;const ml=player.passives.magnet||0;if(ml>0)mult*=1+ml*.5;const marketMagnetLvl=marketLevels['magnet']||0;if(marketMagnetLvl>0)mult*=1+0.10*marketMagnetLvl;if(player.perks&&player.perks.vacuum)mult*=2;player.magnetRange=base*mult;}
